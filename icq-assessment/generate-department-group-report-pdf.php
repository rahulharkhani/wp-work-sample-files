<?php
	...
	if ( in_array('licensee', $user_roles) ) {
		...
		$participant_added_1 = $icq_dashboard->get_participant_added_by_group_id($group_id);
	...
	$D_quadrant_value = $DISC_result['Group']['D_quadrant_value'];
	$I_quadrant_value = $DISC_result['Group']['I_quadrant_value'];
	$S_quadrant_value = $DISC_result['Group']['S_quadrant_value'];
	$C_quadrant_value = $DISC_result['Group']['C_quadrant_value'];
	$team1_sliding_scales_value = $DISC_result['Group']['sliding_scales_value'];
	$participant_counter_1 = $DISC_result['Group']['participant_counter'];
	...
	for ($pageNo = 1; $pageNo <= $pageCount; $pageNo++) {
		...
		if ($pageNo == 1) {
			...
			$write_text = $group_name . ' (' . $Department . ')';
	...
	$generation_result_path = 'pdf/Global-DISC-comparsion-'.$group_name.'-'.$Department.'.pdf';
